...
public class Aplicacao{
	 ...
	 private static int qtdClientes = 0;
	 	...
	 	/**
	     * Método principal da aplicação, que exibe o menu e gerencia a interação com o cliente.
	     * 
	     */
	            ...
	            switch (opcao) {
	                ...
	                case 2:
	                    ...
	                    if (!locar(ent.nextLine())) {
	                        System.out.println("Locação não permitida, o cpf não foi identificado.");
	                    } else {
	                ...
	                case 3:
	                    ...
	                    if (!devolver(ent.nextLine())) {
	                        System.out.println("Devolução não permitida, o cpf não foi identificado.");
	                    } else {
	    ...
	    /**
	     * Valida o nome do cliente, garantindo que não seja nulo e que tenha ao menos dois caracteres.
	     *
	    ...
	    public static void validarNome(String nome) {
	        ...
	        for (int i = 0; i < nome.length(); i++) {
	            ...
	            if ((c < 'A' || (c > 'Z' && c < 'a') || c > 'z') && c != ' ') {
	                throw new IllegalArgumentException("Nome inválido! O nome deve conter apenas letras e "
	                		+ "espaços.");
	            }
	        }
	    }
	    ...
	    /**
	     * Valida o CPF do cliente, garantindo que seja composto apenas por números e tenha exatamente 
	     * 11 dígitos.
	     *
	    ...
	    public static void validarCPF(String cpf) {
	        ...
	        if (cpf.length() != 11) {
	            throw new IllegalArgumentException("CPF inválido! O CPF deve conter exatamente "
	        ...
	        for (int i = 0; i < cpf.length(); i++) {
	            char c = cpf.charAt(i);
	            if (c < '0' || c > '9') {
	                throw new IllegalArgumentException("CPF inválido! Todos os caracteres devem "
	                		+ "ser dígitos numéricos.");
	            }
	        }
	    }
	    ...
	    /**
	     * Realiza a locação de uma bicicleta, se o cliente estiver cadastrado 
	     * e não tiver uma bicicleta alugada.
	     *
	     * @param cpf CPF do cliente.
	     * @return true se a locação for executada, false caso não seja possível a locação.
	     */
	    ...
	    /**
	     * Realiza a devolução de uma bicicleta, se o cliente estiver cadastrado 
	     * e tiver uma bicicleta alugada.
	     *
	     * @param cpf CPF do cliente.
	     * @return true se a devolução for bem-sucedida, 
	     * false caso não encontre o cliente nos dados.
	     */
	    ...
	    /**
	     * Ordena os clientes por total gasto em ordem decrescente,
	     * usando o método de ordenação Bubble Sort.
	     * 
	     */
