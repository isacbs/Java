...
public class Aplicacao {
			...
			try {
				...
				case 2:
					...
					if (!locar(ent.nextLine())) {
						System.out.println(
								"Locação não permitida. O cpf não foi cadastrado ou não é válido ou você digitou apenas letras invés de números.");
					} else {
				...
				case 8:
					System.out.println("Integrantes:" + "\nIsadora Caetano Brandão de Sousa - 10420646"
							+ "\nLuana Fernandes - 10439810" + "\nVídeo de apresentação: https://youtu.be/YB0iPGd0yEA" + "\nFechando...");
					break;
				default:
					System.out.println("Opção inválida!!");
				}
			} catch (Exception e) {
				System.out.println("Erro!!! \nDigite apenas números ou apenas números de 1 a 8.");
				ent.nextLine();
				op = -1;
			}
		} while (op != 8);
	 ...
	 * @author Luana Fernandes @ra 10439810
	 */
	public static void validarNome(String n) {
	 ...
	 * @author Luana Fernandes @ra 10439810
	 */
	private static void ordenarGasto() {
